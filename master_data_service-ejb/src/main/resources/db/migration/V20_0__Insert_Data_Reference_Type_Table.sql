...
insert into "MDATA"."REFERENCE_TYPE" ("REFERENCE_TYPE", "IS_DEFAULT", "CREATED_AT", "CREATED_BY", "UPDATED_AT", "UPDATED_BY") values('Pickup', 1, current timestamp, 'sql import' , NULL, NULL);
insert into "MDATA"."REFERENCE_TYPE" ("REFERENCE_TYPE", "IS_DEFAULT", "CREATED_AT", "CREATED_BY", "UPDATED_AT", "UPDATED_BY") values('Delivery', 1, current timestamp, 'sql import' , NULL, NULL);
insert into "MDATA"."REFERENCE_TYPE" ("REFERENCE_TYPE", "IS_DEFAULT", "CREATED_AT", "CREATED_BY", "UPDATED_AT", "UPDATED_BY") values('Freight payer', 1, current timestamp, 'sql import' , NULL, NULL);
insert into "MDATA"."REFERENCE_TYPE" ("REFERENCE_TYPE", "IS_DEFAULT", "CREATED_AT", "CREATED_BY", "UPDATED_AT", "UPDATED_BY") values('Document', 1, current timestamp, 'sql import' , NULL, NULL);
